...
**********************************************************************/
/*!
 * added kw41z support - Joseph Hindmarsh
...
#endif
#ifndef FNET_CFG_CPU_MKW41Z			// Joseph Hindmarsh
    #define FNET_CFG_CPU_MKW41Z		(0)
#endif
...
#if FNET_CFG_CPU_MK60N512 /* Kinetis */ // Added by Joseph Hindmarsh
    #ifdef FNET_CPU_STR
        #error "More than one CPU selected FNET_CFG_CPU_XXXX"
    #endif

    #include "port/cpu/mk/fnet_mkw41z_config.h"
    #define FNET_CPU_STR    "MKW41Z"
#endif
